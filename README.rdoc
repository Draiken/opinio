...
The most common way to quickly get Opinio working is:
  ...
  rails g opinio:install

This will generate the *Comment* model and also generate the opinio initializer for customization of the engine.
...
If you want to help in any way with *Opinio* please use the github {issues tracker}[https://github.com/Draiken/opinio/issues]
